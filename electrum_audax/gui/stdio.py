...
from electrum_audax import WalletStorage, Wallet
...
from electrum_audaxnetwork import TxBroadcastError, BestEffortRequestFailed
...
class ElectrumGui:
    ...
    def network_dialog(self):
        print("use 'lynx setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'lynx setconfig' to change your settings")
        return True
