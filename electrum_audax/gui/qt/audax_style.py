...
{
    color: #d1d0e2;
    background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #c1c0d8, stop: 1 #a2a0c5);
}
...
QComboBox::down-arrow {
    border-image: url({pkg_dir}/gui/icons/audax_downArrow.png) 0 0 0 0 stretch stretch;
}
...
QAbstractSpinBox::up-arrow {
    image: url({pkg_dir}/gui/icons/audax_upArrow_small.png);
    width: 10px;
    height: 10px;
}

QAbstractSpinBox::up-arrow:disabled, QAbstractSpinBox::up-arrow:off {
    image: url({pkg_dir}/gui/icons/audax_upArrow_small_disabled.png);
}

QAbstractSpinBox::down-arrow {
    image: url({pkg_dir}/gui/icons/audax_downArrow_small.png);
    width: 10px;
    height: 10px;
}

QAbstractSpinBox::down-arrow:disabled, QAbstractSpinBox::down-arrow:off {
    image: url({pkg_dir}/gui/icons/audax_downArrow_small_disabled.png);
}
...
QScrollBar:up-arrow {
    background-image: url({pkg_dir}/gui/icons/audax_upArrow_small.png);
}

QScrollBar:down-arrow {
    background-image: url({pkg_dir}/gui/icons/audax_downArrow_small.png);
}

QScrollBar:left-arrow {
    background-image: url({pkg_dir}/gui/icons/audax_leftArrow_small.png);
}

QScrollBar:right-arrow {
    background-image: url({pkg_dir}/gui/icons/audax_rightArrow_small.png);
}
...
audax_stylesheet = audax_stylesheet.replace('{pkg_dir}', '%s' % pkg_dir_for_css)
